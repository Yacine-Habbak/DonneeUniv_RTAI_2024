...
@section('content')
    ...
    <div class="container-fluid">
        ...
        <p class="texte_explication">Cliquez sur un département pour accéder<br>aux informations détaillées sur les universités,<br>les étudiants, les ressources humaines<br>et les taux d'insertion professionnelle dans <br> le département séléctionné.</p>
